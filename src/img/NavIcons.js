export const Cartwheels = ({classname}) => {
    return(
...
export const CurrencyDropDown = ({classname}) => {
    return(
        <svg className={classname} xmlns="http://www.w3.org/2000/svg" width="8" height="4" viewBox="0 0 8 4" fill="none">
...
export const Logo = ({classname}) => {
    return(
        <svg className={classname} xmlns="http://www.w3.org/2000/svg" width="33" height="30" viewBox="0 0 33 30" fill="none">
<path d="M32.0988 28.6014C32.1313 28.9985 31.8211 29.339 31.4268 29.339H1.59438C1.2009 29.339 0.890922 29.0002 0.922082 28.6037L3.06376 1.34717C3.09168 0.992702 3.38426 0.719727 3.73606 0.719727H29.1958C29.5468 0.719727 29.8391 0.991612 29.868 1.34499L32.0988 28.6014Z" fill="url(#paint0_linear_150_365)"/>
<defs>
...
export const Logosmile1 = ({classname}) => {
    return(
        <svg className={classname} xmlns="http://www.w3.org/2000/svg" width="15" height="10" viewBox="0 0 15 10" fill="none">
...
export const Logosmile2 = ({classname}) => {
    return(
        <svg className={classname} xmlns="http://www.w3.org/2000/svg" width="7" height="5" viewBox="0 0 7 5" fill="none">
...
export const Whitechart = ({classname}) => {
    return(
<svg className={classname} width="24" height="17" viewBox="0 0 24 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Whitecartwheel = ({classname}) => {
    return(
        <svg className={classname} xmlns="http://www.w3.org/2000/svg" width="6" height="7" viewBox="0 0 6 7" fill="none">
<path d="M3.13325 0.977781C1.69316 0.977781 0.505859 2.11324 0.505859 3.49023C0.505859 4.86722 1.69326 6.00268 3.13325 6.00268C4.57333 6.00362 5.76064 4.86816 5.76064 3.49096C5.76064 2.11375 4.57323 0.977539 3.13325 0.977539V0.977781ZM3.13325 4.48139C2.55188 4.48139 2.09685 4.04626 2.09685 3.49033C2.09685 2.93439 2.55188 2.49926 3.13325 2.49926C3.71462 2.49926 4.16965 2.93439 4.16965 3.49033C4.16866 4.02266 3.68897 4.48139 3.13325 4.48139Z" fill="white"/>
</svg>
    )
}

export const CurrencyDropUp = ({classname}) => {
    return(
        <svg className={classname} xmlns="http://www.w3.org/2000/svg" width="8" height="4" viewBox="0 0 8 4" fill="none">
